...
/**
 * Created by chenzhihong on 2017/8/10.
 * 代码中的注释也比较详细了，而且也非常简单，因此这里应该不需要赘述。唯一需要注意的是在画边框时使用的RectF尺寸，如果边框宽度较宽，由于Paint笔触是在边框中线为准，因此如果左上角指定为(0,0)话，会有一半边框宽度的线是画在不见区域的；
 * 这里指定左上角坐标为 0.5f * strokeWidth（即半个边框宽度）即可，
 * 右下角也需要作同样的考虑。
 * 如果要有按压效果可以考虑改变字体颜色 因为默认边框颜色跟随字体颜色
 */
...
public class MyBorderTextview extends TextView {
    ...
    public MyBorderTextview(Context context, AttributeSet attrs, int defStyleAttr) {
...
//            strokeColor = getCurrentTextColor();
        ...
        Log.i("123", "测试：" + paddingLeft + "::" + paddingTop + "::" + paddingRight + "::" + paddingBottom);
        setPadding(paddingLeft, paddingTop, paddingRight, paddingBottom);
    }

    public void setBordeColor(int strokeColor) {
